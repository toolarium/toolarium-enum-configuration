/*
 * AbstractEnumValueConfigurationValueValidator.java
 *
 ...
 * @author patrick
 */
public abstract class AbstractEnumValueConfigurationValueValidator<D, T> implements Serializable, IEnumValueConfigurationValueValidator<T> {
    private static final long serialVersionUID = 5414798875779082500L;
    private EnumValueConfigurationDataType valueDataType;
    private EnumValueConfigurationDataType sizeDataType;
     ...
     */
    protected AbstractEnumValueConfigurationValueValidator(EnumValueConfigurationDataType valueDataType, Class<D> valueClass, EnumValueConfigurationDataType sizeDataType) {
    ...
    /**
     * @see com.github.toolarium.enumeration.configuration.validation.value.IEnumValueConfigurationValueValidator#createValueSize(java.lang.String, java.lang.String)
     */
    @Override
    public EnumValueConfigurationSizing<T> createValueSize(String minValue, String maxValue) throws ValidationException {
        if ((minValue == null || minValue.trim().isEmpty()) && (maxValue == null || maxValue.trim().isEmpty())) {
            return null;
        }

        EnumValueConfigurationSizing<T> result = createEnumValueConfigurationSizing();
        if (result != null) {
     ...
     */
    protected MinMaxValue<T> preapreMinMaxValue(EnumValueConfigurationSizing<T> valueSize, String inputValue) throws ValidationException {
        if (valueSize == null) {
            return null;
        }
    ...
    public boolean equals(Object obj) {
        ...
        AbstractEnumValueConfigurationValueValidator<D, T> other = (AbstractEnumValueConfigurationValueValidator<D, T>) obj;
    ...
    class MinMaxValue<T> implements Serializable {
        ...
        private AbstractEnumValueConfigurationValueValidator getEnclosingInstance() {
            return AbstractEnumValueConfigurationValueValidator.this;
        }
    }
}
